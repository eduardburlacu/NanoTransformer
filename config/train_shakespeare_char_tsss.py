...
out_dir = 'out-shakespeare-char-distributed-tsss'
...
wandb_run_name = 'distributed-mini-gpt-tsss'
...
block_types = ['tp','spd','spd','spd']  # SPD blocks for reduced communication  # None = all TP blocks. Try: ['spd']*6 or ['parallel']*6
