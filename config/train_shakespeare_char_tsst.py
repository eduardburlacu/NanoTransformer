...
out_dir = 'out-shakespeare-char-distributed-tsst'
...
wandb_run_name = 'distributed-mini-gpt-tsst'
...
block_types = ['tp','spd','spd','tp']  # SPD blocks for reduced communication  # None = all TP blocks. Try: ['spd']*6 or ['parallel']*6
