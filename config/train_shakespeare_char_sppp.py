...
out_dir = 'out-shakespeare-char-distributed-sppp'
...
wandb_run_name = 'distributed-mini-gpt-sppp'
...
block_types = ['spd','parallel','parallel','parallel']  # SPD blocks for reduced communication  # None = all TP blocks. Try: ['spd']*6 or ['parallel']*6
