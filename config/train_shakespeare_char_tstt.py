...
out_dir = 'out-shakespeare-char-distributed-tstt'
...
wandb_run_name = 'distributed-mini-gpt-tstt'
...
block_types = ['tp','spd','tp','tp']  # SPD blocks for reduced communication  # None = all TP blocks. Try: ['spd']*6 or ['parallel']*6
