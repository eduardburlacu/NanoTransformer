...
out_dir = 'out-shakespeare-char-distributed-spss'
...
wandb_run_name = 'distributed-mini-gpt-spss'
...
block_types = ['spd','parallel','spd','spd']  # SPD blocks for reduced communication  # None = all TP blocks. Try: ['spd']*6 or ['parallel']*6
