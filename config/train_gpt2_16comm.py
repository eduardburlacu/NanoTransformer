# config for training GPT-2 (124M) with 16 communications
# Mix: 4 TP + 8 SPD = (4×2) + (8×1) = 16 total

wandb_log = True
wandb_project = 'owt'
wandb_run_name = 'gpt2-124M-16comm'
...
tp_size = 2
block_types = ['tp', 'spd', 'spd'] * 4  # Alternating: 4×(TP+SPD+SPD) = 4×4 = 16 comms
compile = False
