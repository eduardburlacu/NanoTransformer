...
out_dir = 'out-shakespeare-char-distributed-spps'
...
wandb_run_name = 'distributed-mini-gpt-spps'
...
block_types = ['spd','parallel','parallel','spd']  # SPD blocks for reduced communication  # None = all TP blocks. Try: ['spd']*6 or ['parallel']*6
